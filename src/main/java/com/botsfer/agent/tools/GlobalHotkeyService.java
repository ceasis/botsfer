 ...
 * Registers global hotkeys that trigger actions even when Botsfer is not focused.
 */
@Component
public class GlobalHotkeyService implements NativeKeyListener {
    ...
    @Tool(description = "Register a global keyboard shortcut. The hotkey works even when Botsfer " +
