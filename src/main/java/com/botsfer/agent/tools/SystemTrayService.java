...
/**
 * System tray icon that shows Botsfer's status (idle, chatting, autonomous mode active).
...
public class SystemTrayService {
    ...
    public void init() {
        ...
        try {
            ...
            PopupMenu popup = new PopupMenu("Botsfer");
            ...
            MenuItem showItem = new MenuItem("Show Botsfer");
            showItem.addActionListener(e -> {
                try {
                    // Open the Botsfer UI in the default browser as a fallback
            ...
            trayIcon = new TrayIcon(icon, "Botsfer — " + currentStatus, popup);
    ...
    public void updateStatus(String status) {
        ...
        if (trayIcon != null) {
            trayIcon.setToolTip("Botsfer — " + status);
    ...
    @Tool(description = "Get the current Botsfer tray icon status.")
