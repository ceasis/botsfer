...
public class SystemControlService {
    ...
    // Processes to never kill (Botsfer + critical system)
    private static final Set<String> PROTECTED = Set.of(
            "java.exe", "javaw.exe",          // Botsfer itself
    ...
    /**
     * Close all user application windows except Botsfer and system-critical processes.
     */
    ...
    public String takeScreenshot() {
        try {
            ...
            java.nio.file.Path dir = java.nio.file.Paths.get(
                    System.getProperty("user.home"), "botsfer_data", "screenshots");
