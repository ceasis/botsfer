...
## Project Overview
Botsfer is a floating desktop chatbot (Java 17, Spring Boot 3.2.5, JavaFX 21). A swirling ball sits on the desktop; double-click expands a chat panel. It connects to 9 messaging platforms and supports pluggable skills.
...
Server port: `8765` (configurable via `BOTSFER_PORT` env var)
